...
public class MoveArmEvent implements org.apache.thrift.TBase<MoveArmEvent, MoveArmEvent._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("MoveArmEvent");
  ...
  static {
    schemes.put(StandardScheme.class, new MoveArmEventStandardSchemeFactory());
    schemes.put(TupleScheme.class, new MoveArmEventTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(MoveArmEvent.class, metaDataMap);
  }
   ...
   */
  public MoveArmEvent(MoveArmEvent other) {
    if (other.isSetLimb()) {
  ...
  public MoveArmEvent deepCopy() {
    return new MoveArmEvent(this);
  }
   ...
   * @see Limb
   */
  public MoveArmEvent setLimb(Limb limb) {
    this.limb = limb;
    return this;
  }
  ...
  public MoveArmEvent setPos(Position pos) {
    this.pos = pos;
    return this;
  }
  ...
  public MoveArmEvent setOri(Orientation ori) {
    this.ori = ori;
    return this;
  }
  ...
  public MoveArmEvent setSpeed(Speed speed) {
    this.speed = speed;
    return this;
  }
  ...
  public MoveArmEvent setAngls(Angles angls) {
    this.angls = angls;
    return this;
  }
   ...
   * @see Reference_sys
   */
  public MoveArmEvent setMode(Reference_sys mode) {
    this.mode = mode;
    return this;
  }
   ...
   * @see Kinematics
   */
  public MoveArmEvent setKin(Kinematics kin) {
    this.kin = kin;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof MoveArmEvent)
      return this.equals((MoveArmEvent)that);
    return false;
  }

  public boolean equals(MoveArmEvent that) {
    if (that == null)
      return false;
  ...
  public int compareTo(MoveArmEvent other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    MoveArmEvent typedOther = (MoveArmEvent)other;
  ...
  private static class MoveArmEventStandardSchemeFactory implements SchemeFactory {
    public MoveArmEventStandardScheme getScheme() {
      return new MoveArmEventStandardScheme();
    }
  }

  private static class MoveArmEventStandardScheme extends StandardScheme<MoveArmEvent> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, MoveArmEvent struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MoveArmEvent struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class MoveArmEventTupleSchemeFactory implements SchemeFactory {
    public MoveArmEventTupleScheme getScheme() {
      return new MoveArmEventTupleScheme();
    }
  }

  private static class MoveArmEventTupleScheme extends TupleScheme<MoveArmEvent> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, MoveArmEvent struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, MoveArmEvent struct) throws org.apache.thrift.TException {
