...
public class MoveHeadEvent implements org.apache.thrift.TBase<MoveHeadEvent, MoveHeadEvent._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("MoveHeadEvent");

  private static final org.apache.thrift.protocol.TField ANGLE_FIELD_DESC = new org.apache.thrift.protocol.TField("angle", org.apache.thrift.protocol.TType.DOUBLE, (short)1);
  private static final org.apache.thrift.protocol.TField SPEED_FIELD_DESC = new org.apache.thrift.protocol.TField("speed", org.apache.thrift.protocol.TType.I32, (short)2);
  private static final org.apache.thrift.protocol.TField TIMEOUT_FIELD_DESC = new org.apache.thrift.protocol.TField("timeout", org.apache.thrift.protocol.TType.DOUBLE, (short)3);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new MoveHeadEventStandardSchemeFactory());
    schemes.put(TupleScheme.class, new MoveHeadEventTupleSchemeFactory());
  }

  public double angle; // required
  public int speed; // required
  public double timeout; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(MoveHeadEvent.class, metaDataMap);
  }
   ...
   */
  public MoveHeadEvent(MoveHeadEvent other) {
  ...
  public MoveHeadEvent deepCopy() {
    return new MoveHeadEvent(this);
  }
  ...
  public MoveHeadEvent setAngle(double angle) {
    this.angle = angle;
    setAngleIsSet(true);
    return this;
  }
  ...
  public MoveHeadEvent setSpeed(int speed) {
    this.speed = speed;
    setSpeedIsSet(true);
    return this;
  }
  ...
  public MoveHeadEvent setTimeout(double timeout) {
    this.timeout = timeout;
    setTimeoutIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof MoveHeadEvent)
      return this.equals((MoveHeadEvent)that);
    return false;
  }

  public boolean equals(MoveHeadEvent that) {
    if (that == null)
      return false;
  ...
  public int compareTo(MoveHeadEvent other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    MoveHeadEvent typedOther = (MoveHeadEvent)other;
  ...
  private static class MoveHeadEventStandardSchemeFactory implements SchemeFactory {
    public MoveHeadEventStandardScheme getScheme() {
      return new MoveHeadEventStandardScheme();
    }
  }

  private static class MoveHeadEventStandardScheme extends StandardScheme<MoveHeadEvent> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, MoveHeadEvent struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // TIMEOUT
            if (schemeField.type == org.apache.thrift.protocol.TType.DOUBLE) {
              struct.timeout = iprot.readDouble();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MoveHeadEvent struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      oprot.writeDouble(struct.timeout);
      oprot.writeFieldEnd();
  ...
  private static class MoveHeadEventTupleSchemeFactory implements SchemeFactory {
    public MoveHeadEventTupleScheme getScheme() {
      return new MoveHeadEventTupleScheme();
    }
  }

  private static class MoveHeadEventTupleScheme extends TupleScheme<MoveHeadEvent> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, MoveHeadEvent struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, MoveHeadEvent struct) throws org.apache.thrift.TException {
