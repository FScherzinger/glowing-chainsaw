...
public class PickEvent implements org.apache.thrift.TBase<PickEvent, PickEvent._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("PickEvent");
  ...
  static {
    schemes.put(StandardScheme.class, new PickEventStandardSchemeFactory());
    schemes.put(TupleScheme.class, new PickEventTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(PickEvent.class, metaDataMap);
  }
   ...
   */
  public PickEvent(PickEvent other) {
    if (other.isSetLimb()) {
   ...
   * @see Limb
   */
  public PickEvent setLimb(Limb limb) {
    this.limb = limb;
    return this;
  }
  ...
  public PickEvent setPos(Position pos) {
    this.pos = pos;
    return this;
  }
  ...
  public PickEvent setOri(Orientation ori) {
    this.ori = ori;
    return this;
  }
  ...
  public PickEvent setSpeed(Speed speed) {
    this.speed = speed;
    return this;
  }
  ...
  public PickEvent setAngls(Angles angls) {
    this.angls = angls;
    return this;
  }
   ...
   * @see Reference_sys
   */
  public PickEvent setMode(Reference_sys mode) {
    this.mode = mode;
    return this;
  }
   ...
   * @see Kinematics
   */
  public PickEvent setKin(Kinematics kin) {
    this.kin = kin;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof PickEvent)
      return this.equals((PickEvent)that);
    return false;
  }

  public boolean equals(PickEvent that) {
    if (that == null)
      return false;
  ...
  public int compareTo(PickEvent other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    PickEvent typedOther = (PickEvent)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PickEvent(");
    boolean first = true;
  ...
  private static class PickEventStandardSchemeFactory implements SchemeFactory {
    public PickEventStandardScheme getScheme() {
      return new PickEventStandardScheme();
    }
  }

  private static class PickEventStandardScheme extends StandardScheme<PickEvent> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, PickEvent struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PickEvent struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class PickEventTupleSchemeFactory implements SchemeFactory {
    public PickEventTupleScheme getScheme() {
      return new PickEventTupleScheme();
    }
  }

  private static class PickEventTupleScheme extends TupleScheme<PickEvent> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, PickEvent struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, PickEvent struct) throws org.apache.thrift.TException {
