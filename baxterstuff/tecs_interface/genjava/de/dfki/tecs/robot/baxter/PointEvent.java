...
public class PointEvent implements org.apache.thrift.TBase<PointEvent, PointEvent._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("PointEvent");
  ...
  static {
    schemes.put(StandardScheme.class, new PointEventStandardSchemeFactory());
    schemes.put(TupleScheme.class, new PointEventTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(PointEvent.class, metaDataMap);
  }
   ...
   * @see Limb
   */
  public PointEvent setLimb(Limb limb) {
    this.limb = limb;
    return this;
  }
  ...
  public PointEvent setPos(Position pos) {
    this.pos = pos;
    return this;
  }
  ...
  public PointEvent setOri(Orientation ori) {
    this.ori = ori;
    return this;
  }
  ...
  public PointEvent setSpeed(Speed speed) {
    this.speed = speed;
    return this;
  }
  ...
  public PointEvent setAngls(Angles angls) {
    this.angls = angls;
    return this;
  }
   ...
   * @see Reference_sys
   */
  public PointEvent setMode(Reference_sys mode) {
    this.mode = mode;
    return this;
  }
   ...
   * @see Kinematics
   */
  public PointEvent setKin(Kinematics kin) {
    this.kin = kin;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof PointEvent)
      return this.equals((PointEvent)that);
    return false;
  }

  public boolean equals(PointEvent that) {
    if (that == null)
      return false;
  ...
  public int compareTo(PointEvent other) {
    ...
    PointEvent typedOther = (PointEvent)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PointEvent(");
    boolean first = true;
  ...
  private static class PointEventStandardSchemeFactory implements SchemeFactory {
    public PointEventStandardScheme getScheme() {
      return new PointEventStandardScheme();
    }
  }

  private static class PointEventStandardScheme extends StandardScheme<PointEvent> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, PointEvent struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PointEvent struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class PointEventTupleSchemeFactory implements SchemeFactory {
    public PointEventTupleScheme getScheme() {
      return new PointEventTupleScheme();
    }
  }

  private static class PointEventTupleScheme extends TupleScheme<PointEvent> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, PointEvent struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, PointEvent struct) throws org.apache.thrift.TException {
